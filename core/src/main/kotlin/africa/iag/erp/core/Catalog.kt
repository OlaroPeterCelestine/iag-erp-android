...
fun erpModules(): List<ErpModule> = listOf(
    ...
    ErpModule(
        ...
        group = "Projects",
        description = "Contracts, contractors, amendments, invoices, bonds, and completion certificates.",
        icon = "handshake",
        color = 0xFF047857,
        entities = listOf("Contracts", "Contractors", "Contract Amendments", "Contractor Invoices", "Contractor Ledgers", "Performance Bonds", "Completion Certificates"),
        seed = listOf(
            seedRecord("contract-manager", "Contracts", "CTR-2026-012", "Roastery civil works", "Active", amount = 180000000.0),
            seedRecord("contract-manager", "Contractors", "Mukwano Builders", "CTR-012", "Active"),
            seedRecord("contract-manager", "Contractor Invoices", "CINV-2026-008", "Certificate 2", "Pending", amount = 48000000.0),
        ),
    ),
    ErpModule(
        id = "fleet",
        ...
        seed = listOf(
            ...
            seedRecord("fleet", "Drivers", "Joseph Ssewanyana", "DRV-008", "Active"),
    ...
    ErpModule(
        ...
        label = "CRM",
        group = "Commercial",
        description = "Accounts, leads, opportunities, contacts, follow-ups, and complaints.",
        icon = "groups",
        color = 0xFFBE123C,
        entities = listOf("Accounts", "Leads", "Opportunities", "Contacts", "Follow-ups", "Complaints", "Activities"),
        seed = listOf(
            seedRecord("crm", "Accounts", "Shoprite Uganda", "Retail", "Active"),
            seedRecord("crm", "Leads", "Shoprite Lugogo", "Retail listing", "Open", amount = 0.0, fields = mapOf("Owner" to "Sarah Nambi", "Source" to "Walk-in")),
            seedRecord("crm", "Opportunities", "OPP-2026-014", "Listing pack · Q4", "Open", amount = 48000000.0),
        ),
    ),
    ErpModule(
        id = "logistics",
    ...
    ErpModule(
        ...
        seed = listOf(
            seedRecord("pos", "POS Terminal", "Front Till", "Main Shop", "Active"),
            seedRecord("pos", "Open Tickets", "T-104", "Table 6 · dine-in", "Open", amount = 86000.0),
    ...
    ErpModule(
        id = "folders",
        label = "Cabinets & Folders",
        group = "Records",
        description = "Cabinets, folders, and file requests for the document store.",
        icon = "folder_open",
        color = 0xFFA16207,
        entities = listOf("Cabinets", "Folders", "File Requests"),
        seed = listOf(
            seedRecord("folders", "Cabinets", "Statutory", "Finance packs", "Active"),
            seedRecord("folders", "Folders", "Finance — 2026", "Statutory packs", "Active"),
            seedRecord("folders", "File Requests", "FR-2026-009", "URA TIN pack", "Open"),
        ),
    ),
    ErpModule(
        id = "documents",
        label = "DMS Documents",
        group = "Records",
        description = "Documents, incoming files, versions, shares, and attachment history.",
        icon = "folder",
        color = 0xFF57534E,
        entities = listOf("Documents", "Incoming Files", "Versions", "Shares", "Attachments", "History", "Deleted Records"),
        seed = listOf(
            seedRecord("documents", "Documents", "Lease — Namanve warehouse", "Legal · PDF", "Active"),
            seedRecord("documents", "Incoming Files", "Supplier COA pack", "Kyagalanyi", "Open"),
        ),
    ),
    ErpModule(
        id = "reports",
